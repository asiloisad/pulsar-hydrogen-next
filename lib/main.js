...
export function activate() {
  ...
  store.subscriptions.add(
    atom.commands.add("atom-text-editor:not([mini])", {
      ...
      'hydrogen-next:next-cell': () => cellNavi.nextCell(),
      'hydrogen-next:previous-cell': () => cellNavi.previousCell(),
      'hydrogen-next:select-cell': () => cellNavi.selectCell(),
      'hydrogen-next:select-up': () => cellNavi.selectUp(),
      'hydrogen-next:select-down': () => cellNavi.selectDown(),
      'hydrogen-next:move-cell-up': () => cellNavi.moveCellUp(),
      'hydrogen-next:move-cell-down': () => cellNavi.moveCellDown(),
    })
  )
  store.subscriptions.add(
