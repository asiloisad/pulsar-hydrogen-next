...
export const SOCKET_OPTIONS = {
  ...
  // Heartbeat settings (for kernel liveness detection)
  heartbeatInterval: 5000, // ms between heartbeats
  heartbeatTimeout: 15000, // ms before declaring kernel dead
  heartbeatMaxMissed: 3, // number of missed heartbeats before dead
};
