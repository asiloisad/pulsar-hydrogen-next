...
export function provideAutocompleteResults(store) {
  const autocompleteProvider = {
    ...
    suggestionPriority: atom.config.get("hydrogen-next.autocompleteSuggestionPriority"),
    // It won't suppress providers with lower priority.
    excludeLowerPriority: false,
    suggestionDetailsEnabled: atom.config.get("hydrogen-next.showInspectorResultsInAutocomplete"),
