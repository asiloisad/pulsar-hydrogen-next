...
export function clearResults({ editor, kernel, markers }) {
  ...
  // Emit event for scroll-keeper to handle position recovery
...
export function createResultAsync(
  ...
  return new Promise((resolve) => {
    ...
    const resultView = inline
      ? new ResultView(markers, kernel, editor, row, shouldShowResult)
      : null;
    const outputStore = resultView?.outputStore || null;
